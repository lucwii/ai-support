...
export default function OnboardingForm() {
  ...
  return (
    <div
      className="flex rounded-2xl overflow-hidden w-full max-w-[860px]"
      style={{
    ...
    >
      ...
      <div className="flex-1 flex flex-col" style={{ background: '#0F172A' }}>
        {/* Top bar — like ProductDemo browser bar */}
        <div
        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div>
            {/* Step content — animira se kroz opacity/transform na step promjenu */}
            <div
            ...
            >
              ...
              <div className="mb-6">
                ...
                <h1 className="font-sora font-bold text-[22px] text-white" style={{ letterSpacing: '-0.02em' }}>
                  {STEPS[step].title}
                </h1>
            ...
            <div className="flex items-center justify-between mt-8 pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              {step < STEPS.length - 1 ? (
                <button
                  ...
                  onClick={goNext}
                  className="text-[13px] font-semibold px-6 py-2.5 rounded-xl text-white transition-all duration-150 disabled:opacity-30 disabled:cursor-not-allowed hover:-translate-y-px"
                  style={{
                    background: isStep0Valid
                ...
                <button
                  ...
                  disabled={loading}
                  onClick={submit}
                  className="text-[13px] font-semibold px-6 py-2.5 rounded-xl text-white transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-px"
                  style={{
